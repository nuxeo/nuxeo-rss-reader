...
<body>
  ...
  <div class="feedBlock">
    ...
    <#list userFeeds as feed>
      <li>
        <a href="removeFeed?id=${feed.id}" class="removeFeed"><img
                src="${skinPath}/icons/remove.png" alt=""/></a>
      ...
      <#if globalFeeds?has_content>
        <form id="addGlobaFeedForm" method="GET" action="addGlobalFeed">
          ...
          <div class="fieldRow">
            ...
            <a href="javascript: submitForm('addGlobaFeedForm')"
               class="addGlobalFeed"><img src="${skinPath}/icons/add.png"
                                          alt=""/></a>
          </div>
        </form>
      </#if>
      ...
      <form id="addNewFeedForm" method="GET" action="addNewFeed">
        <div class="fieldRow">
          ...
          <input class="field feedlink" type="text" name="feedLink"
                 value="Feed link"/>
          <a href="javascript: submitForm('addNewFeedForm')" class="addNewFeed">
            <img src="${skinPath}/icons/add.png" alt=""/>
          </a>
        </div>
      </form>
    </#if>
