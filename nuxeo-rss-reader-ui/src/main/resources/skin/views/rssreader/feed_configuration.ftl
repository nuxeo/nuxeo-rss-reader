...
<div class="feedBlock">
  ...
  <div class="popupContent">
    ...
    <#if globalFeeds?has_content>
      <form id="addGlobalFeedForm" method="POST" action="addGlobalFeed?language=${Context.locale.language?html}">
      ...
      <form id="addNewFeedForm" method="POST" action="addNewFeed?language=${Context.locale.language?html}">
      ...
      <table class="dataList">
        ...
        <tr>
          ...
          <td class="actionColumn">
            <form method="POST" action="removeFeed?language=${Context.locale.language?html}">
